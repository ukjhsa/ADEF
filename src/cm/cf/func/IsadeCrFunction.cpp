...
void IsadeCrFunction::setup(const Configuration & config, const PrototypeManager & pm)
{
...
unsigned int IsadeCrFunction::number_of_parameters() const
{
    return 0;
}
