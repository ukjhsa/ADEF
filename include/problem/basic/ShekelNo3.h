...
/**
@brief ShekelNo3 function.

@par The configuration
ShekelNo3 has no extra configurations.@n
...
- optimal_solution: -10.5364
.
See setup() for the details.
*/
class ShekelNo3 : public Problem
{
public:
...
/// @copydoc Problem::Object
    ...
    ShekelNo3() : Problem("Shekel No.3")
    {
    }
    ShekelNo3(const ShekelNo3& rhs) = default;

/**
@brief Clone the current class.
@sa clone_impl()
*/
    std::shared_ptr<ShekelNo3> clone() const
    {
        return std::dynamic_pointer_cast<ShekelNo3>(clone_impl());
    }
/**
@brief Set up the internal states.

ShekelNo3's configuration should be
- JSON configuration
@code
"Problem": {
    "classname" : "ShekelNo3"
...
*/
    ...
    void evaluation_function(std::shared_ptr<Individual> individual) const override
    {
        ...
        std::array<Object, row> c = {{0.1, 0.2, 0.2, 0.4, 0.4, 0.6, 0.3, 0.7, 0.5, 0.5}};
...
private:
    ...
    {
        return std::make_shared<ShekelNo3>(*this);
    }
};
